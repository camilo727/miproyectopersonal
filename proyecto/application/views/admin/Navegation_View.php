  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        <div class="sidebar-brand-text mx-3"><?php echo $nombre;?>  <?php echo $Apellido;?></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url()?>index.php/Admini_con/Admin_producto">Producto</a>
            <a class="collapse-item" href="">Inventarios</a>
            <a class="collapse-item" href="">Usuarios</a>
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">campos:</h6>
            <a class="collapse-item" href="">libre</a>
            <a class="collapse-item" href="blank.html">libre</a>
          </div>
        </div>
      </li>
